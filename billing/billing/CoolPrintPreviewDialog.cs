...
namespace billing
{
    ...
    internal partial class CoolPrintPreviewDialog : Form
    {
        ...
        public CoolPrintPreviewDialog(Control parentForm,string Totalinp,string cusdata)
        {
            InitializeComponent();
            total = Convert.ToDecimal(Totalinp);
            number = cusdata.Split('\n');
            if (parentForm != null)
            {
        ...
        private void toolStripButton1_Click(object sender, EventArgs e)
        {
            try
            {
                using (var client = new WebClient())
                {
                    ...
                    string temp = "This message is from TechnoKraft, This message is sent to notify you that your bike with registration number "+number[1]+" is serviced and ready to deliver. you bill amount is "+total+" Rs";
