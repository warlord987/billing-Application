...
namespace billing
{
    public partial class NewInvioce : Form
    {
        ...
        private void PrintDocumentInvoice_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            Image CompanyLogo = bmp; //add the company logo image in resources
            ...
            e.Graphics.DrawString("address line-3", FontDesc, Brushes.Black, new Point(110, Height += Yincrement));
